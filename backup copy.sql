...
INSERT INTO `django_content_type` VALUES (2,'admin','logentry'),(4,'auth','group'),(3,'auth','permission'),(5,'auth','user'),(6,'contenttypes','contenttype'),(8,'movie','actor'),(9,'movie','director'),(10,'movie','movie_directedby'),(11,'movie','movieactor_awards'),(12,'movie','moviecast'),(13,'movie','moviedirector_awards'),(14,'movie','movies'),(1,'movie','person'),(15,'movie','rating'),(16,'movie','userinfo'),(7,'sessions','session');
...
INSERT INTO `movie_director` VALUES (62,'Rajamouli',12345,'he did bahubali','http://www.forbesindia.com/media/images/2015/Dec/topimg_29083_ss_rajamouli.jpg'),(66,'Bhavesh',123345,'Student at pes','http://icons.iconarchive.com/icons/dtafalonso/android-lollipop/512/Movie-Studio-icon.png'),(68,'James',128394,'James Francis Cameron is a Canadian filmmaker and environmentalist, who is best known for making science fiction and epic films for the Hollywood mainstream. Cameron first gained recognition for directing The Terminator','https://cdn.britannica.com/84/160284-050-695B1DE3/James-Cameron-2012.jpg'),(69,'Steven',1234223,'Steven Allan Spielberg (/ˈspiːlbɜːrɡ/; born December 18, 1946) is an American filmmaker.  considered the first summer blockbuster.[3] His subsequent releases focused typically on science fiction/adventure films such as Close Encounters of the Third Kind (1977), Raiders of the Lost Ark (1981), E.T. the Extra-Terrestrial (1982), and Jurassic Park (1993), which became archetypes of modern Hollywood escapist filmmaking.[4]','https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Steven_Spielberg_by_Gage_Skidmore.jpg/440px-Steven_Spielberg_by_Gage_Skidmore.jpg'),(70,'Christopher',988787,'Christopher Edward Nolan, CBE is a British-American film director, screenwriter, and producer, who is known for making personal, distinctive films within the Hollywood mainstream. Having made his directorial debut with Following, Nolan gained considerable attention for his second feature Memento.','https://upload.wikimedia.org/wikipedia/commons/c/c4/Christopher_Nolan%2C_London%2C_2013_%28crop%29.jpg');
