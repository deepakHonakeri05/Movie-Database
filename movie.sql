...
INSERT INTO `movie_director` VALUES (62,'Rajamouli',12345,'he did bahubali','http://www.forbesindia.com/media/images/2015/Dec/topimg_29083_ss_rajamouli.jpg'),(66,'bhavesh',123345,'sdfsgfrgrd','http://icons.iconarchive.com/icons/dtafalonso/android-lollipop/512/Movie-Studio-icon.png');
...
CREATE TABLE `movie_movie_directedby` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `movie_movie_directedby_mov_id_id_dir_id_id_204ef444_uniq` (`mov_id`,`dir_id`),
...
INSERT INTO `movie_movie_directedby` VALUES (1,62,101),(2,66,101);
...
CREATE TABLE `movie_moviecast` (
  ...
  `mov_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `movie_moviecast_act_id_id_mov_id_id_95049d25_uniq` (`act_id`,`mov_id`),
...
CREATE TABLE `movie_rating` (
  ...
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `movie_rating_user_id_id_mov_id_id_896aecab_uniq` (`user_id`,`mov_id`),
